...
/**
 * CHANGED: Renamed file to f1_signer
 */
...
class RequestSigner {
   ...
   */
	...
	/**
	 * CHANGED: getSignatureBaseString() to static method
	 */
    private static function getSignatureBaseString($httpMethod, $url, $oAuthOptions, &$debugInfo) {
